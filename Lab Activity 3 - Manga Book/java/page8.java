...
public class page8 extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Zoom In | Zoom Out
        PhotoView photoView = (PhotoView) findViewById(R.id.page8);
        photoView.setImageResource(R.drawable.chapt197);
