...
public class page1 extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Zoom In | Zoom Out
        PhotoView photoView = (PhotoView) findViewById(R.id.page1);
        photoView.setImageResource(R.drawable.chapt190);
