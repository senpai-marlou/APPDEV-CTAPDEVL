...
public class page5 extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Zoom In | Zoom Out
        PhotoView photoView = (PhotoView) findViewById(R.id.page5);
        photoView.setImageResource(R.drawable.chapt194);
