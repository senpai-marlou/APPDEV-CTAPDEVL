...
public class page7 extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Zoom In | Zoom Out
        PhotoView photoView = (PhotoView) findViewById(R.id.page7);
        photoView.setImageResource(R.drawable.chapt196);
