...
public class page6 extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Zoom In | Zoom Out
        PhotoView photoView = (PhotoView) findViewById(R.id.page6);
        photoView.setImageResource(R.drawable.chapt195);
